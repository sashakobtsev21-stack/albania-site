...
/**
 * Контент-модель Albania Guidebook (SPEC §11, v3.1).
 *
 ...
 * для живущих в Албании (риелторы, клининг и т.п.). Слаги ↔ ru/uk лейблы в i18n
 * (`serviceRubrics`).
 */
...
const articleBase = z.object({
   ...
   * это релевантно. Все поля — строки (гибко: «Вход свободный», «500 лек»,
