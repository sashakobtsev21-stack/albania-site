---
title: 'Berat, Albania: City of a Thousand Windows Guide'
description: 'Berat guide: the UNESCO castle, the Mangalem and Gorica quarters, the Onufri museum, the Osum canyon, plus where to stay, eat and how to get there.'
...
accessFrom:
  tirana:
    km: 120
    duration: '~2–2.5 h by road'
    note: 'Direct buses and furgons run through the day from Tirana; no train.'
gallery:
  - src: '/images/berat-albania-guide/panorama.webp'
    alt: 'Panorama of the Mangalem and Gorica quarters of Berat facing each other across the Osum valley'
    credit: 'Photo: Arianit / Wikimedia Commons, CC BY-SA 4.0'
  - src: '/images/berat-albania-guide/lead-mosque.webp'
    alt: 'The tall stone minaret and lead-covered dome of the Lead Mosque (Xhamia e Plumbit) in Berat'
    credit: 'Photo: Sebleouf / Wikimedia Commons, CC BY-SA 4.0'
  - src: '/images/berat-albania-guide/berat-by-night.webp'
    alt: 'The lit windows of the Mangalem houses climbing the hillside in Berat after dark'
    credit: 'Photo: gailhampshire / Wikimedia Commons, CC BY 2.0'
affiliate:
  - partner: 'trip-hotels'
    label: 'Find a place to stay in Berat'
    position: 'inline'
  - partner: 'trip-tours'
    label: 'Browse Osum canyon and wine day tours from Berat'
    position: 'body-end'
sources:
  - 'en.wikipedia.org'
  - 'whc.unesco.org'
...
<figure class="figure">
<img src="/images/berat-albania-guide/mangalem-windows.webp" alt="The white Ottoman houses of Mangalem rising up the hillside in Berat with the castle hill above" width="1120" height="840" loading="lazy" decoding="async" />
<figcaption>The Mangalem quarter — tiers of wide-windowed Ottoman houses that give Berat its "thousand windows" name. <span class="figure__credit">Photo: Wolfgang Sauber / Wikimedia Commons, CC BY-SA 4.0</span></figcaption>
</figure>

<figure class="figure">
<img src="/images/berat-albania-guide/mangalem-street.webp" alt="A narrow cobbled lane between stone houses climbing the hillside in the Mangalem quarter of Berat" width="880" height="1174" loading="lazy" decoding="async" />
<figcaption>A cobbled Mangalem lane — the quarter is best explored slowly on foot, uphill. <span class="figure__credit">Photo: Wolfgang Sauber / Wikimedia Commons, CC BY-SA 4.0</span></figcaption>
</figure>
...
<figure class="figure">
<img src="/images/berat-albania-guide/castle-gate.webp" alt="The main stone gateway and crenellated walls of Berat Castle under a blue sky" width="1000" height="750" loading="lazy" decoding="async" />
<figcaption>The main gate into Berat's Kala — a fortress that is still a lived-in neighbourhood, not an empty ruin. <span class="figure__credit">Photo: Wolfgang Sauber / Wikimedia Commons, CC BY-SA 4.0</span></figcaption>
</figure>

Inside the walls, the standout is the **Onufri National Iconographic Museum**, set in the 18th-century Church of the Dormition of St Mary. It's named for Onufri, the 16th-century master icon painter known for the vivid red he used, and it gathers icons and a gilded iconostasis from Berat's many Byzantine and post-Byzantine churches under one roof. Entry fees and opening hours change with the season — check the current rate and times before you go. <!-- TODO: actual Onufri Museum ticket price/hours from owner or official source -->

<figure class="figure">
<img src="/images/berat-albania-guide/onufri-church.webp" alt="The porticoed Church of the Dormition of St Mary housing the Onufri Museum inside Berat castle, with its bell tower" width="1280" height="848" loading="lazy" decoding="async" />
<figcaption>The Church of the Dormition of St Mary in the castle — home to the Onufri icon museum. <span class="figure__credit">Photo: Pasztilla aka Attila Terbócs / Wikimedia Commons, CC BY-SA 4.0</span></figcaption>
</figure>

<figure class="figure">
<img src="/images/berat-albania-guide/onufri-iconostasis.webp" alt="The gilded carved iconostasis hung with icons inside the Onufri Museum church in Berat" width="1120" height="840" loading="lazy" decoding="async" />
<figcaption>The gilded iconostasis and icons inside the Onufri Museum — Berat's religious art under one roof. <span class="figure__credit">Photo: Adam Jones / Wikimedia Commons, CC BY-SA 2.0</span></figcaption>
</figure>
...
<figure class="figure">
<img src="/images/berat-albania-guide/gorica-bridge.webp" alt="The arched Ottoman stone footbridge of Gorica crossing the Osum river in Berat" width="1120" height="840" loading="lazy" decoding="async" />
<figcaption>The Gorica Bridge — the old stone span linking Berat's two historic quarters across the Osum. <span class="figure__credit">Photo: Avi1111 dr. avishai teicher / Wikimedia Commons, CC BY-SA 4.0</span></figcaption>
</figure>
...
<figure class="figure">
<img src="/images/berat-albania-guide/castle-aerial.webp" alt="Aerial view of Berat Castle on its hilltop ridge surrounded by walls with the valley beyond" width="1120" height="837" loading="lazy" decoding="async" />
<figcaption>Berat from above — the castle ridge over the old town, with the hills and wine country beyond. <span class="figure__credit">Photo: Arianit / Wikimedia Commons, CC BY-SA 4.0</span></figcaption>
</figure>
...
<figure class="figure">
<img src="/images/berat-albania-guide/osum-river.webp" alt="The Osum river flowing past the old town of Berat under a moody sky" width="1280" height="960" loading="lazy" decoding="async" />
<figcaption>The Osum river below the old town — the thread that the whole of Berat is built around. <span class="figure__credit">Photo: Leeturtle / Wikimedia Commons, CC BY-SA 4.0</span></figcaption>
</figure>
...
- Starting in the capital? Read the [best things to do in Tirana](/cities/things-to-do-in-tirana/).
- Driving the day trips? See [how to rent a car in Albania](/car-rental/how-to-rent-a-car/).
