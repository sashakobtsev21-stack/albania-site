---
title: 'Gjirokaster, Albania: The Stone City Guide'
description: 'Gjirokaster guide: the UNESCO stone city, the hilltop castle and weapons museum, the Old Bazaar, the tower-houses, Cold War tunnel and day trips.'
...
accessFrom:
  saranda:
    km: 120
    duration: '~1.5 h by road'
    note: 'Common pairing with a Blue Eye stop on the way; buses and furgons also run the route.'
  tirana:
    km: 230
    duration: '~3.5–4 h by road'
    note: 'Buses and furgons run through the day via the inland motorway; no train.'
gallery:
  - src: '/images/gjirokaster-albania-guide/townscape.webp'
    alt: 'The houses of Gjirokastër climbing the green hillside below the castle ridge'
    credit: 'Photo: Marmontel / Wikimedia Commons, CC BY 2.0'
  - src: '/images/gjirokaster-albania-guide/stone-roofs.webp'
    alt: 'Aerial view over the grey stone-slab roofs of Gjirokastër clustered up the hillside'
    credit: 'Photo: malenki / Wikimedia Commons, CC BY-SA 3.0'
  - src: '/images/gjirokaster-albania-guide/castle-bastion.webp'
    alt: 'A stone bastion and crenellated wall of Gjirokastër castle above the trees with mountains behind'
    credit: 'Photo: David Stanley / Wikimedia Commons, CC BY 2.0'
  - src: '/images/gjirokaster-albania-guide/dusk-roofs.webp'
    alt: 'The slate roofs of Gjirokastër at dusk with the lit castle on the ridge above'
    credit: 'Photo: Wolfgang Sauber / Wikimedia Commons, CC BY-SA 4.0'
affiliate:
  - partner: 'trip-hotels'
    label: 'Find a place to stay in Gjirokastër'
    position: 'inline'
  - partner: 'trip-tours'
    label: 'Browse Blue Eye and stone-city day tours'
    position: 'body-end'
sources:
  - 'en.wikipedia.org'
  - 'whc.unesco.org'
...
<figure class="figure">
<img src="/images/gjirokaster-albania-guide/winding-lane.webp" alt="A steep cobbled lane between stone walls in Gjirokastër with the castle on the ridge above" width="740" height="942" loading="lazy" decoding="async" />
<figcaption>A cobbled Gjirokastër lane climbing toward the castle — the old town is best explored slowly on foot, uphill. <span class="figure__credit">Photo: Sharon Hahn Darlin / Wikimedia Commons, CC BY 2.0</span></figcaption>
</figure>
...
<figure class="figure">
<img src="/images/gjirokaster-albania-guide/castle-terrace.webp" alt="The stone clock tower and the Albanian and EU flags on a terrace of Gjirokastër castle with mountains behind" width="1280" height="854" loading="lazy" decoding="async" />
<figcaption>The castle terrace and clock tower, the Albanian flag flying over the Drino valley. <span class="figure__credit">Photo: Marcin Konsek / Wikimedia Commons, CC BY-SA 4.0</span></figcaption>
</figure>
...
<figure class="figure">
<img src="/images/gjirokaster-albania-guide/castle-gallery.webp" alt="The long stone vaulted gallery and ramparts inside Gjirokastër castle with the clock tower at the end" width="1280" height="853" loading="lazy" decoding="async" />
<figcaption>Inside the fortress — the vaulted stone galleries that hold the weapons museum, with the clock tower beyond. <span class="figure__credit">Photo: Marcin Konsek / Wikimedia Commons, CC BY-SA 4.0</span></figcaption>
</figure>

Ticket prices and opening hours for the castle and its museum change with the season, so check the current rate and times before you go. <!-- TODO: actual Gjirokastër castle ticket price/hours from owner or official source -->
...
<figure class="figure">
<img src="/images/gjirokaster-albania-guide/drino-valley.webp" alt="Wide panorama of the Drino valley and surrounding mountains seen from Gjirokastër castle" width="1280" height="260" loading="lazy" decoding="async" />
<figcaption>The Drino valley from the castle — the strategic view that made Gjirokastër a fortress town. <span class="figure__credit">Photo: Leeturtle / Wikimedia Commons, CC BY-SA 4.0</span></figcaption>
</figure>
...
<figure class="figure">
<img src="/images/gjirokaster-albania-guide/old-bazaar.webp" alt="The cobbled junction of the Old Bazaar in Gjirokastër lined with stone shops, the castle wall above" width="1280" height="850" loading="lazy" decoding="async" />
<figcaption>The Old Bazaar — stone shops and cafés at the cobbled crossroads below the castle. <span class="figure__credit">Photo: Alessandro Giangiulio / Flickr, CC BY 2.0</span></figcaption>
</figure>
...
<figure class="figure">
<img src="/images/gjirokaster-albania-guide/from-zekate-house.webp" alt="The view over Gjirokastër and the castle from the stone balcony of a tower-house" width="1280" height="960" loading="lazy" decoding="async" />
<figcaption>Looking out over the town and castle from a Gjirokastër tower-house — the kullë were built for both defence and display. <span class="figure__credit">Photo: Perigrinator / Wikimedia Commons, CC BY-SA 4.0</span></figcaption>
</figure>
...
<figure class="figure">
<img src="/images/gjirokaster-albania-guide/stone-roof-detail.webp" alt="A close-up of the grey stone-slab roof of a Gjirokastër house with the mountains behind" width="1120" height="840" loading="lazy" decoding="async" />
<figcaption>The grey stone-slab roofs that give Gjirokastër its "stone city" name, laid like heavy slate. <span class="figure__credit">Photo: Wolfgang Sauber / Wikimedia Commons, CC BY-SA 4.0</span></figcaption>
</figure>
...
<figure class="figure">
<img src="/images/gjirokaster-albania-guide/lamb-meal.webp" alt="A plate of slow-cooked lamb with bread on a table at a Gjirokastër café" width="1280" height="1707" loading="lazy" decoding="async" />
<figcaption>Slow-cooked lamb with bread at a Gjirokastër café — the rib-sticking food of the Albanian south. <span class="figure__credit">Photo: Sharon Hahn Darlin / Wikimedia Commons, CC BY 2.0</span></figcaption>
</figure>

As ever, we don't quote specific prices or menus for individual venues because they change with the season — check current boards when you go, and ask your guesthouse for their pick.
...
<figure class="figure">
<img src="/images/gjirokaster-albania-guide/castle-bastion.webp" alt="A stone bastion of Gjirokastër castle rising above the trees with hazy mountains behind" width="1024" height="768" loading="lazy" decoding="async" />
<figcaption>A bastion of the fortress above the trees — the castle dominates every approach to Gjirokastër. <span class="figure__credit">Photo: David Stanley / Wikimedia Commons, CC BY 2.0</span></figcaption>
</figure>
...
- **When to go.** Spring and autumn are the most pleasant for the walking; midsummer is hot. See our guide to the [best time to visit Albania](/planning/best-time-to-visit/) for the month-by-month picture.
...
- Heading to the coast? See our [Saranda travel guide](/cities/saranda-albania-guide/) for the south.
- Want the inland counterpart? Read the [Berat travel guide](/cities/berat-albania-guide/), the other UNESCO stone town.
- Tying it together by car? Follow the [Albania road trip itinerary](/routes/albania-road-trip-itinerary/) and our [how to rent a car in Albania](/car-rental/how-to-rent-a-car/) guide.
