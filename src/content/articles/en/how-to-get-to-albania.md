---
title: 'How to Get to Albania: Flights, Airports, Ferries & Buses'
description: 'How to get to Albania in 2026: Tirana airport, direct flights from the UK and Europe, the Vlora airport question, plus buses and ferries from neighbours.'
...
cover:
  src: '/images/how-to-get-to-albania/cover.webp'
  alt: 'The terminal building of Tirana International Airport Nënë Tereza, the main gateway to Albania'
...
affiliate:
  - partner: 'kiwitaxi'
    ...
    position: 'inline'
sources:
  - 'https://www.wizzair.com/en-gb/cheap-flights-from-london-to-tirana'
  - 'https://www.tirana-airport.com/en/partners/4/Airlines'
  - 'https://www.vlorecircle.com/post/vlora-international-airport-delayed-2026-expat-guide'
  - 'https://en.wikipedia.org/wiki/Vlora_International_Airport'
  - 'https://albaniatourguide.com/getting-to-albania/'
  - 'https://www.ferryhopper.com/en/blog/ferry-news/italy-albania-ferry-schedules-2026'
  - 'https://www.ferryhopper.com/en/ferry-routes/direct/sarande-corfu'
  - 'https://www.alongdustyroads.com/posts/how-to-get-from-tirana-airport-to-city-centre'
cluster: 'transport-routes [head]'
photoSources:
  - src: '/images/how-to-get-to-albania/cover.webp'
    author: 'Karelj'
    license: 'Public Domain'
    sourceUrl: 'https://commons.wikimedia.org/wiki/File:Building_of_Tirana_airpot_2018_1.jpg'
  - src: '/images/how-to-get-to-albania/adria-ferry-durres.webp'
    author: 'Albinfo'
    license: 'CC BY-SA 4.0'
    sourceUrl: 'https://commons.wikimedia.org/wiki/File:AF_Francesca_in_Durr%C3%ABs.jpg'
  - src: '/images/how-to-get-to-albania/durres-port.webp'
    author: 'Rakoon'
    license: 'CC0'
    sourceUrl: 'https://commons.wikimedia.org/wiki/File:0546_Durr%C3%ABs.jpg'
  - src: '/images/how-to-get-to-albania/tirana-skyline.webp'
    author: 'Rakoon'
    license: 'CC0'
    sourceUrl: 'https://commons.wikimedia.org/wiki/File:0697_July_2017_in_Tirana.jpg'
  - src: '/images/how-to-get-to-albania/saranda-from-greece.webp'
    author: 'Piotrus'
    license: 'CC BY-SA 3.0'
    sourceUrl: 'https://commons.wikimedia.org/wiki/File:Albania_062_-_Sarand%C3%AB_harbour.jpg'
draft: false
---
...
The airport is **about 17 km northwest of the city**, and getting into Tirana is quick and cheap. The **Rinas Express bus** runs 24/7 between the terminal and a stop near the National Opera by Skanderbeg Square for around **400 LEK (about EUR 4)**. An official **airport taxi** runs roughly **EUR 20–25** into the centre, taking 20–25 minutes. Pre-booked private transfers cost a little more but meet you at arrivals — useful late at night or if you're heading straight on south. The full breakdown is in the [Tirana airport transfers guide](/transport/tirana-airport-transfers/).

<figure class="figure">
<img src="/images/how-to-get-to-albania/tirana-skyline.webp" alt="The skyline of central Tirana, the Albanian capital, with apartment blocks and hills behind" width="1280" height="848" loading="lazy" decoding="async" />
<figcaption>Central Tirana. Most arrivals land at TIA and reach the centre in under half an hour by bus or taxi. <span class="figure__credit">Photo: Rakoon / Wikimedia Commons, CC0; sourceUrl: https://commons.wikimedia.org/wiki/File:0697_July_2017_in_Tirana.jpg</span></figcaption>
</figure>
...
Albania has a long-standing ferry link with **Italy**, landing mostly at **Durrës** (and seasonally Vlora), which is handy if you're driving or want to fold Albania into an Italian trip. The workhorse route is **Bari to Durrës**, an overnight crossing of about **8 to 9 hours** with fares from roughly **EUR 35–50** for a passenger; **Brindisi to Vlora** is the quickest at around **4.5 hours** from about **EUR 45**; and **Ancona to Durrës** is the long haul at **16–19 hours** from about **EUR 78**. Operators include **Adria Ferries, Ventouris, GNV and others**. These are proper car ferries, so you can bring a vehicle, and overnight sailings let you book a cabin or travel cheaply on deck. The full route-by-route breakdown — operators, crossing times and foot-versus-car fares — is in the [Italy to Albania ferry guide](/transport/italy-to-albania-ferry/).

<figure class="figure">
<img src="/images/how-to-get-to-albania/adria-ferry-durres.webp" alt="An Adria Ferries ship docked at the port of Durrës in Albania" width="1280" height="853" loading="lazy" decoding="async" />
<figcaption>An Adria Ferries vessel at Durrës. Overnight ferries from Bari, Brindisi and Ancona land here and carry cars. <span class="figure__credit">Photo: Albinfo / Wikimedia Commons, CC BY-SA 4.0; sourceUrl: https://commons.wikimedia.org/wiki/File:AF_Francesca_in_Durr%C3%ABs.jpg</span></figcaption>
</figure>
...
<figure class="figure">
<img src="/images/how-to-get-to-albania/durres-port.webp" alt="The waterfront and port area of Durrës on the Albanian Adriatic coast" width="1280" height="848" loading="lazy" decoding="async" />
<figcaption>Durrës, Albania's main port and the landing point for the Italy ferries, half an hour from the capital. <span class="figure__credit">Photo: Rakoon / Wikimedia Commons, CC0; sourceUrl: https://commons.wikimedia.org/wiki/File:0546_Durr%C3%ABs.jpg</span></figcaption>
</figure>

## Arriving by ferry from Corfu

If you're island-hopping in Greece, the **Corfu to Saranda ferry** is the fastest way into southern Albania — a **30-minute high-speed crossing** (longer on the car ferry) from around **EUR 20–25**, with up to a few dozen sailings a day in high summer. It lands you right on the Riviera at Saranda, perfectly placed for Ksamil, Butrint and the southern beaches without backtracking through Tirana. Full timetable, fares and the passport rules are in the [Saranda to Corfu ferry guide](/transport/saranda-corfu-ferry/).

<figure class="figure">
<img src="/images/how-to-get-to-albania/saranda-from-greece.webp" alt="Sarandë harbour on the southern Albanian coast, the arrival point for the ferry from Corfu" width="1120" height="1493" loading="lazy" decoding="async" />
<figcaption>Sarandë, where the Corfu ferry lands — the quickest route from Greece onto the Albanian Riviera. <span class="figure__credit">Photo: Piotrus / Wikimedia Commons, CC BY-SA 3.0; sourceUrl: https://commons.wikimedia.org/wiki/File:Albania_062_-_Sarand%C3%AB_harbour.jpg</span></figcaption>
</figure>
...
If you're coming from the UK or northern Europe, **fly into Tirana** — it's cheap, fast, and the obvious choice. Heading specifically for the **southern beaches** from Greece, the **Corfu–Saranda ferry** beats flying to Tirana and driving five hours south. Bringing a **car or combining with Italy**, take an **Italy–Durrës ferry**. Already in the **Balkans**, the **bus network** is inexpensive and links every neighbour. Whatever you choose, plan the onward leg too: see [how to get around Albania](/transport/how-to-get-around-albania/) for moving between cities once you've landed, and the [Tirana airport transfers guide](/transport/tirana-airport-transfers/) for that first ride into town. Treat the routes and fares here as June 2026 guidance and reconfirm before booking.
