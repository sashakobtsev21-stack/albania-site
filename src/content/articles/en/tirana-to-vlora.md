---
title: 'Tirana to Vlora: Bus, Furgon, Car & Travel Times'
description: 'Tirana to Vlora in 2026: bus and furgon times and fares, the drive via Durres and Fier, transfers, and why there is still no flight or train.'
slug: 'tirana-to-vlora'
lang: 'en'
category: 'transport'
publishedAt: 2026-07-01
updatedAt: 2026-07-01
cover:
  src: '/images/tirana-to-vlora/cover.webp'
  alt: 'The turquoise bay and pebble beach at Vlora on the southern Adriatic coast of Albania'
coverCredit: 'Photo: Tomasz Lewicki / Wikimedia Commons, CC BY-SA 2.0; sourceUrl: https://commons.wikimedia.org/wiki/File:Vlora_Panorama.jpg'
gallery: []
affiliate:
  - partner: 'localrent'
    label: 'Compare rental cars for the south'
    position: 'inline'
  - partner: 'kiwitaxi'
    label: 'Get a Tirana-Vlora transfer quote'
    position: 'body-end'
sources:
  - 'https://travel.gjirafa.com/en/bus/tirana-to-vlora'
  - 'https://albaniatourguide.com/how-to-get-from-tirana-to-vlore-by-bus-by-taxi-by-car/'
  - 'https://adventurealbania.com/albania-bus-timetable/'
  - 'https://www.albaniafaq.com/local-transport-in-albania/'
cluster: 'transport-routes [mid]'
photoSources:
  - src: '/images/tirana-to-vlora/cover.webp'
    author: 'Tomasz Lewicki'
    license: 'CC BY-SA 2.0'
    sourceUrl: 'https://commons.wikimedia.org/wiki/File:Vlora_Panorama.jpg'
  - src: '/images/tirana-to-vlora/independence-square.webp'
    author: 'Sharon Hahn Darlin'
    license: 'CC BY 2.0'
    sourceUrl: 'https://commons.wikimedia.org/wiki/File:Vlor%C3%AB,_Albania_31_December_2022_-_Independence_Monument.jpg'
  - src: '/images/tirana-to-vlora/lungomare.webp'
    author: 'Leeturtle'
    license: 'CC BY-SA 4.0'
    sourceUrl: 'https://commons.wikimedia.org/wiki/File:Lungomare_area_in_Vlor%C3%AB,_south_Albania.jpg'
  - src: '/images/tirana-to-vlora/coast-south.webp'
    author: 'Julianruizp'
    license: 'CC BY-SA 4.0'
    sourceUrl: 'https://commons.wikimedia.org/wiki/File:Playa_de_Vlora.jpg'
  - src: '/images/tirana-to-vlora/muradie-mosque.webp'
    author: 'Timuspics'
    license: 'CC BY-SA 4.0'
...
<figure class="figure">
<img src="/images/tirana-to-vlora/coast-south.webp" alt="The rugged rocky coastline just south of Vlora where the Adriatic meets the start of the Albanian Riviera" width="1280" height="853" loading="lazy" decoding="async" />
<figcaption>The coast turning wild just south of Vlora, where the Riviera begins. A car is what makes those smaller coves reachable. <span class="figure__credit">Photo: Julianruizp / Wikimedia Commons, CC BY-SA 4.0; sourceUrl: https://commons.wikimedia.org/wiki/File:Playa_de_Vlora.jpg</span></figcaption>
</figure>

The reason to drive is what lies beyond Vlora rather than the trip itself. South of town the road climbs over the **Llogara Pass** into the Riviera proper — Dhermi, Himare and the beaches that buses reach awkwardly. If you're planning to explore that coast on your own schedule, a car earns its keep; if you just want to reach Vlora and stay put, the bus is cheaper and easier. Read [how to rent a car in Albania](/car-rental/how-to-rent-a-car/) for the insurance and deposit terms before you book, and note that some policies exclude rough coastal tracks.
...
<figure class="figure">
<img src="/images/tirana-to-vlora/independence-square.webp" alt="The Independence Monument on Flag Square in Vlora under a blue sky, with a person crossing the paved plaza" width="1280" height="960" loading="lazy" decoding="async" />
<figcaption>The Independence Monument on Flag Square, marking Albania's 1912 declaration of independence in Vlora. <span class="figure__credit">Photo: Sharon Hahn Darlin / Wikimedia Commons, CC BY 2.0; sourceUrl: https://commons.wikimedia.org/wiki/File:Vlor%C3%AB,_Albania_31_December_2022_-_Independence_Monument.jpg</span></figcaption>
</figure>

But the real draw is the coast. Vlora sits where the Adriatic meets the Ionian, and it's the northern gateway to the **Albanian Riviera** — the run of turquoise bays and pebble beaches that starts just south over the Llogara Pass. Many travellers treat the city as a staging post: a night on the Lungomare, then onward down the coast. If that's your plan, the [Albanian Riviera guide](/attractions/albanian-riviera/) covers what's south, and the [Saranda guide](/cities/saranda-albania-guide/) the far end of it.

<figure class="figure">
<img src="/images/tirana-to-vlora/muradie-mosque.webp" alt="The stone Muradie Mosque, a 16th-century Ottoman mosque in the centre of Vlora, Albania" width="1280" height="853" loading="lazy" decoding="async" />
<figcaption>The 16th-century Muradie Mosque in central Vlora, attributed to the Ottoman architect Sinan. <span class="figure__credit">Photo: Timuspics / Wikimedia Commons, CC BY-SA 4.0; sourceUrl: https://commons.wikimedia.org/wiki/File:Murachi_Mosque,_Vlora,_Albania.jpg</span></figcaption>
</figure>
...
If you're still mapping the trip, line this up with the wider [how to get around Albania](/transport/how-to-get-around-albania/) overview, the long [Tirana to Saranda](/transport/tirana-to-saranda/) run further down the same coast, and — if you're arriving from Italy — the [Italy to Albania ferry guide](/transport/italy-to-albania-ferry/), since Brindisi sailings land right here in Vlora.
